...
= The layout changes each time it is displayed in Masonry Grid. Is this a bug? =

This is a specification of this plugin.

This is because images must be loaded to calculate the height of an element, and the timing of the completion of loading affects the layout.

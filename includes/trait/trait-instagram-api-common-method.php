...
trait Instagram_API_Common_Method {
	 ...
	 * 
	 * @param bool          $soft_force_refresh   Get Data from API and Force Cache Refresh (Soft; cache lifetime is 120sec)
	 * 
	 * 
	 ...
	 * 
	 */
	public static function get_media_data( $user_id, $access_token, $media_count = 100, $fields = [], $advanced = null, $soft_force_refresh = false ) {
		...
		// Force Refresh; cache lifetime = 60sec
		if( $soft_force_refresh ) {
			$lifetime = 120;
		}
		...
		if( $soft_force_refresh || ! isset( $cached_data->data ) ) {
